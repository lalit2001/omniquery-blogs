...
### 4. Returns Results in Under 500ms
...
|---------|----------------------|--------------------|
| Time to insight | Days (new request) | < 500ms |
...
**Try OmniQuery free at [omniquery.ai](https://omniquery.ai)** — or [book a live demo](/contact?type=demo) and we'll show you what it can do on your own data.
